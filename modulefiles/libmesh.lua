...
local libmesh_arch = name.."/"..version.."/"..compiler.."/"..compiler_version.."/"..mpi_implementation.."/"..mpi_version.."/petsc/"..petsc_version.."/"..blas_implementation.."/"..blas_version.."/boost/"..boost_version.."/hdf5/"..hdf5_version.."/vtk/"..vtk_version
